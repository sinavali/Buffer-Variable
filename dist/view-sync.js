 ...
 * @private
 */
const viewSyncRegistry = new WeakMap();
/**
        ...
        const poll = () => {
            ...
            if (version !== this.lastVersion) {
                ...
                const data = this.boundPaths.size > 0
                    ? Object.fromEntries([...this.boundPaths].map(p => [p.split('.').pop(), this.view.decodePartial(p, this.sab)]))
