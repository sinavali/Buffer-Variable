 ...
 * ```
 */
View.prototype.set = function <T extends object>(this: View<T>, path: string, value: any, sab: SharedArrayBuffer): void {
 ...
 * ```
 */
View.prototype.bulkSet = function <T extends object>(this: View<T>, pathsAndValues: Record<string, any>, sab: SharedArrayBuffer): void {
  if (!this.options.mutable) {
    throw new Error('Cannot mutate immutable view');
  }
  if (sab.byteLength < this.schema.byteSize) {
 ...
 * ```
 */
View.prototype.patch = function <T extends object>(this: View<T>, path: string, partial: any, sab: SharedArrayBuffer): void {
  if (!this.options.mutable) {
    throw new Error('Cannot mutate immutable view');
  }
  if (sab.byteLength < this.schema.byteSize) {
